...
namespace OData8VersioningPrototype.ApiConventions
{
    ...
    /// </summary>
    [DebuggerDisplay("{Version}, Depricated:{Description.IsDeprecated}")]
    public sealed class ApiVersionInfo : IEquatable<ApiVersionInfo>, IEquatable<ApiVersion>
    {
        ...
        public ApiVersionInfo(ApiVersion version, string? versionApiName = null, bool depricated = false)
        {
            ...
            Version = version;
            Description = new ApiVersionDescription(version, versionApiName ?? version.ToString(), depricated);
        ...
        /// <summary>
        /// Api version description for ApiExplorer
        /// </summary>
        public ApiVersionDescription Description { get; }
        /// <summary>
        ...
        /// <summary>
        /// Route path part for versioning
        /// </summary>
        public string PathPartName => Description.GroupName;
